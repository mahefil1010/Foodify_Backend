...
namespace Foodify.API.Controllers
{
    ...
    public class OrderItemController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            return Ok(new ApiResponse<IEnumerable<OrderItemResponseDto>>
            {
                StatusCode = 200,
                Status = true,
                Message = "Success",
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            ...
            if (result == null)
                return NotFound(new ApiResponse<OrderItemResponseDto>
                {
                    StatusCode = 404,
                    Status = false,
                    Message = "Not found",
            ...
            return Ok(new ApiResponse<OrderItemResponseDto>
            {
                StatusCode = 200,
                Status = true,
                Message = "Success",
        ...
        public async Task<IActionResult> GetWithPagination([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10)
        {
            ...
            return Ok(new ApiResponse<PaginatedResult<OrderItemResponseDto>>
            {
                StatusCode = 200,
                Status = true,
                Message = "Success",
        ...
        [HttpPost]
        public async Task<IActionResult> Insert([FromBody] CreateOrderItemDto dto)
        {
